...
*/}}
{{- define "konga.name" -}}
{{- printf "%s-konga" (include "enabler.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-konga" (include "enabler.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-frontend" (include "enabler.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-frontend" (include "enabler.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-frontendconfig" (include "enabler.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-frontendconfig" (include "enabler.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
